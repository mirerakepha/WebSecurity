...
impl ErrorMessage {
    fn to_str(&self) -> String {
        match self {
            ...
            ErrorMessage::UserNolongerExist => "User belonging to this token nolonger exists".to_string(),
...
impl HttpError {
    ...
    pub fn into_http_response(self) -> HttpResponse {
        match self.status {
            ...
            _=> {
                eprintln!(
                    "Warning: Missing pattern match. Converted status code {} for 500.", self.status
                );
