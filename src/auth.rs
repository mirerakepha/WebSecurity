//ensuures only authenticated users can access certain endpoint in your application
...
impl FromRequest for Authenticated {
    ...
    fn from_request(req: &actix_web::HttpRequest, _payload: &mut actix_web::dev::Payload) -> Self::Future {
        ...
        let result = match value {
            ...
            None => Err(ErrorInternalServerError(HttpError::server_error("Authentication error"))),
        };
        ready(result)
    }
}
